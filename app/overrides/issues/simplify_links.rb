...
Deface::Override.new(
    ...
    :insert_after => 'erb[loud]:contains("preview_link preview_new_issue_path")',
...
Deface::Override.new(
    ...
    :insert_after => 'erb[loud]:contains("preview_link preview_edit_issue_path(:project_id => @project, :id => @issue), \'issue-form\'")',
